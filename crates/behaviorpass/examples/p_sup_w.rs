...
use behaviorpass::{Actions, Base, FnState, Exit, MailAddr, RestartPolicy, Strategy, Supervising, Watching, stop_on_abnormal_death, run};
...
async fn main() {
    ...
    let stack = Supervising::new(Watching::new(base::<Kid>(), stop_on_abnormal_death), |i| i as u64, 1, |_| base::<Never>(), Strategy::OneForOne, RestartPolicy::Transient, 3, Duration::MAX);
