...
use behaviorpass::{Actions, Base, Exit, Supervising, Watching, stop_on_abnormal_death, run};
...
async fn main() {
    ...
    let stack = Supervising::new(Watching::new(base(), stop_on_abnormal_death), 1, |_| base(), 3);
