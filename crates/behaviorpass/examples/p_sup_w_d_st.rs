...
use behaviorpass::{Actions, Base, Deadlined, Exit, StashRoute, Stashing, Supervising, Watching, otp_propagation, run};
...
async fn main() {
    ...
    let stack = Supervising::new(Watching::new(Deadlined::new(Stashing::new(base(), |_: &u64| StashRoute::Deliver), None, |_| Ok(Step::Continue)), otp_propagation), 1, |_| base(), 3);
