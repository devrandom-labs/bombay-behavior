...
use behaviorpass::{Actions, Base, FnState, Deadlined, Exit, MailAddr, RestartPolicy, StashRoute, Stashing, Strategy, Supervising, Watching, stop_on_abnormal_death, run};
...
async fn main() {
    ...
    let stack = Supervising::new(Watching::new(Deadlined::new(Stashing::new(base::<Kid>(), |_: &u64| StashRoute::Deliver), None, |_| Ok(Step::Continue)), stop_on_abnormal_death), |i| i as u64, 1, |_| base::<Never>(), Strategy::OneForOne, RestartPolicy::Transient, 3, Duration::MAX);
