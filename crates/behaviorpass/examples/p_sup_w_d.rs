...
async fn main() {
    ...
    let stack = Supervising::new(Watching::new(Deadlined::new(base::<Kid>(), None, |_| Ok(Step::Continue)), stop_on_abnormal_death), |i| i as u64, 1, |_| base::<Never>(), Strategy::OneForOne, RestartPolicy::Transient, 3, Duration::MAX);
