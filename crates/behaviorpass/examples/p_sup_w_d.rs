...
use behaviorpass::{Actions, Base, Deadlined, Exit, Supervising, Watching, otp_propagation, run};
...
async fn main() {
    ...
    let stack = Supervising::new(Watching::new(Deadlined::new(base(), None, |_| Ok(Step::Continue)), otp_propagation), 1, |_| base(), 3);
