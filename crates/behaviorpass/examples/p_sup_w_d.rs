...
use behaviorpass::{Actions, Base, Deadlined, Exit, Supervising, Watching, stop_on_abnormal_death, run};
...
async fn main() {
    ...
    let stack = Supervising::new(Watching::new(Deadlined::new(base(), None, |_| Ok(Step::Continue)), stop_on_abnormal_death), 1, |_| base(), 3);
