...
use behaviorpass::{Admit, Base, Exit, Phased, Supervising, Watching, otp_propagation, run};
...
async fn main() {
    ...
    let stack = Supervising::new(Watching::new(Phased::new(base_phase(), false, |_, _| Admit::Deliver), otp_propagation), vec![base()], |_| base(), 3);
