...
use behaviorpass::{Actions, Base, Exit, StashRoute, Stashing, Supervising, Watching, stop_on_abnormal_death, run};
...
async fn main() {
    ...
    let stack = Supervising::new(Watching::new(Stashing::new(base(), |_: &u64| StashRoute::Deliver), stop_on_abnormal_death), 1, |_| base(), 3);
