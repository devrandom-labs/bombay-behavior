...
## [0.17.1](https://github.com/devrandom-labs/bombay-behavior/compare/bombay-behavior-v0.17.0...bombay-behavior-v0.17.1) - 2026-09-18

### Other

- *(behavior)* prove the Bombay stop shape; fix(macros): facade-first Actors resolution ([#68](https://github.com/devrandom-labs/bombay-behavior/pull/68))

## [0.17.0](https://github.com/devrandom-labs/bombay-behavior/compare/bombay-behavior-v0.16.0...bombay-behavior-v0.17.0) - 2026-09-17
...
- complete settlement custody contract ([#62](https://github.com/devrandom-labs/bombay-behavior/pull/62))
...
- Add the sealed `ChildOccurrenceProduct` and downstream
  `ChildOccurrenceShape`. Static runtimes can derive
  `ChildOccurrences<Children, Shape>` storage from concrete behavior leaves,
  `ChildChoice`, and `Never` without reclassifying Behavior-owned nodes or
  adding bounds to domain generics.
