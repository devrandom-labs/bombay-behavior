...
type BreakerActions<A, ReplySends> =
    Actions<A, Never, BreakerSends<ReplySends, InterpreterRequests<ScheduleAfter>>, NoBirths>;
    ...
    Route::Sends: behavior::SendsFor<BreakerEvent<A, Route>>,
{
    ...
    type Sends = BreakerSends<Route::Sends, InterpreterRequests<ScheduleAfter>>;
    type Ph = Never;
