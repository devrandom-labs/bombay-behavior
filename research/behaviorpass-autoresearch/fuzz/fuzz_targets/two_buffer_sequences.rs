...
use behaviorpass::{Behavior, Fsm, MailAddr, Move, Never, Spec, StashRoute, User, UserEvent};
...
type Stack = behaviorpass::Spec<behaviorpass::Stashing<Fsm<MailAddr, Vec<u64>, u64, Phase, Never>>>;
