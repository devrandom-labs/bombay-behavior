...
#[allow(clippy::trivially_copy_pass_by_ref, reason = "the stash route signature is fn(&Msg)")]
...
type Stack = behaviorpass::Spec<
    behaviorpass::At<behaviorpass::Stashing<Fsm<MailAddr, Vec<u64>, u64, Phase, Never>>>,
>;
