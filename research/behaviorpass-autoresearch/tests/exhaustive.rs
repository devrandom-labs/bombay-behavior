...
#[test]
#[allow(clippy::too_many_lines, reason = "exhaustive enumeration over 54 configurations is inherently a straight-line walk")]
        ...
        for policy in [
            ...
            for maximum in 0_u32..3 {
                for window in [None, Some(2_u64)] {
                    let window_duration =
                        window.map_or(Duration::MAX, Duration::from_nanos);
