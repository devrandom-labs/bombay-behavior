...
> **Archived:** The run recorded by this directory is complete. Do not execute
> the commands below. They are preserved only to make the original procedure
> reproducible; the independent Resource Pool validation has its own runbook.

## Start

Do not run `/loop prepare`; this directory is the prepared scaffold.
