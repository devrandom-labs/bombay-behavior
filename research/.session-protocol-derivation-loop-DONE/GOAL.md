...
> **Archived campaign:** This is the original completed Supervised Worker
> derivation. It is retained as historical evidence and must not be used as an
> active loop scaffold. See `research/README.md`.
