...
- The historical `supervision_sequences`, `pool_sequences`, and
  `catalogue_sequences` targets completed 5,000 fuzz executions each under the
  locked Fenix input's nightly sanitizer toolchain. Replacement atomic fuzz
  coverage is catalogued in `atomic-actor-verification.md`.
